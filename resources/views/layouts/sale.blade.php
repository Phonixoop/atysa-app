                    ...
                    <div class="user-box text-center">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu user-pro-dropdown">
                                ...
                                <!-- item-->
                                <a href="/sale/profile" class="dropdown-item notify-item">
                                    <span>پروفایل</span>
                                </a>
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            {{-- <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/sale/users/all">همه</a></li>
                                    <li><a href="/sale/users/new">افزودن</a></li>
                                    <li><a href="/sale/userplate/all">بشقاب شخصی کاربران</a></li>
                                </ul>
                            </li> --}}
                            <li>
                                <a href="javascript: void(0);">
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/sale/companies/all">همه</a></li>
                                    <li><a href="/sale/companies/new">افزودن</a></li>
                                </ul>
                            </li>
