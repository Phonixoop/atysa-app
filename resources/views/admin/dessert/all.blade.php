                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/dessert/single/{{$row->id}}" class="btn btn-success waves-effect waves-light">ویرایش</a>
                                <a href="/admin/dessert/duplicate/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">کپی کردن</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody> 
