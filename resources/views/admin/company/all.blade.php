                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/companies/single/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">ویرایش</a>
                                <a href="/admin/companies/personels/{{$row->id}}" class="btn btn-primary waves-effect waves-light">مشاهده کاربران</a>
                                <a href="/admin/companies/sidedish/{{$row->id}}" class="btn btn-warning waves-effect waves-light">مشاهده پیش غذا</a>
                                <a href="/admin/companies/users/daily/{{$row->id}}" class="btn btn-success waves-effect waves-light">ریز سفارش های امروز</a>
                                <a href="/admin/companies/users/endofmonth/{{$row->id}}" class="btn btn-success waves-effect waves-light">ریز سفارش های تا آخر ماه</a>
                            </td>
