...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" action="/admin/hotbox/update" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="capacity" name="capacity" value="{{$single->capacity}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
