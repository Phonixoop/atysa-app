                ...
                <table id="datatable2" class="table table-bordered dt-responsive datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$row->id}}</td>
                            <td>
                                @if(isset($extra[$key]['food']))
                                {{$extra[$key]['food']}}
                                @endif
                            </td>
                            <td>{{$row->zaherKolli}}</td>
                            <td>{{$row->rangeGhaza}}</td>
                            <td>
                                {{$row->bafteGhaza}}
                            </td>
                            <td>
                            ...
                            <td>
                                @if(isset($extra[$key]['user']))
                                    کاربر : {{$extra[$key]['user']}}<br/>
                                @endif
                                @if(isset($extra[$key]['company']))
                                    شرکت : {{$extra[$key]['company']}}<br/>
                                @endif
                            </td>
                            <td>
