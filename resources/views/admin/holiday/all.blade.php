...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">تعطیلات</h4>
            ...
            <div class="card-body">
                ...
                <table id="datatable2" class="table table-bordered dt-responsive datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>{{\Morilog\Jalali\CalendarUtils::strftime('Y/m/d', strtotime($row->date))}}</td>
                            <td>
                                ...
                                <a href="/admin/holiday/single/{{$row->id}}" class="btn btn-success waves-effect waves-light">ویرایش</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody> 
