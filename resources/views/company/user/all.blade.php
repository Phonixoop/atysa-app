                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/company/users/single/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">ویرایش</a>
                                <a href="/company/users/plan/{{$row->id}}" class="btn btn-warning waves-effect waves-light">مشاهده برنامه غذایی</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody> 
