...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">کاربران شرکت {{$company->name}}</h4>
                ...
                <table id="datatable2" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$row->mobile}}</td>
                            <td>
                                <a href="/sale/companies/login/{{$row->id}}" class="btn btn-warning waves-effect waves-light">ورود</a>
                                <a href="/sale/companies/users/plan/{{$row->id}}" class="btn btn-primary waves-effect waves-light">مشاهده برنامه غذایی</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody> 
