...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">ویرایش برنامه غذایی <?php echo e($month); ?></h4>
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" action="/admin/plans/months/update" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="month" name="month" value="<?php echo e($month); ?>"/>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/plan/month/single.blade.php ENDPATH**/ ?>