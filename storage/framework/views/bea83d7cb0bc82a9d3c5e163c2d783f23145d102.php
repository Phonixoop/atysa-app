                                ...
                                <tbody>
                                    <?php for($i = 0; $i < 40; $i++): ?>
                                        <tr class="table-active">
                                            ...
                                            <td><input class="form-control" type="text" name="materials[<?php echo e($i); ?>][name]"/></td>
                                            <td><input class="form-control" type="text" name="materials[<?php echo e($i); ?>][weight]"/></td>
                                        </tr>
                                    <?php endfor; ?>
                                </tbody>
                            </table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/plate/new.blade.php ENDPATH**/ ?>