...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            >افزودن برنامه غذایی جدید برای پلن 
                <a href="/admin/plans/single/<?php echo e($plan->id); ?>" style="color: #1D9FA4;;"><?php echo e($plan->name); ?></a>
            </h4>
            <?php if(isset($plan["months"])): ?>
            <div style="display: flex">
                <div style="display: flex; gap:5px;">
                    <?php $__currentLoopData = $plan["months"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a 
                    href="/admin/plans/months/single/<?php echo e($plan->id); ?>/<?php echo e($item["month"]); ?>"
                    style="background-color:#1D9FA4; color:#ffffff; text-align: center; border-radius: 1000px; min-width: 50px;"><?php echo e($item["month"]); ?></a>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" action="/admin/plans/months/create" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="planId" value="<?php echo e($plan->id); ?>" />
                    <div class="form-group row">
                        <label for="month" class="col-md-2 col-form-label">ماه</label>
                        <div class="col-md-10">
                            <input required class="form-control" type="text" id="month" name="month"/>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/plan/month/new.blade.php ENDPATH**/ ?>