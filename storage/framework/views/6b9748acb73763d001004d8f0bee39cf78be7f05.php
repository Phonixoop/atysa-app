                ...
                <table id="datatable2" class="table table-bordered dt-responsive datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <th>نام بشقاب</th>
                            <th>نام کارمند یا شماره موبایل</th>
                            <th>عملیات</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if(isset($row->userId)): ?>
                              <?php $userDet = App\Models\User::find($row->userId); ?>
                              <?php if(isset($userDet)): ?>
                              <?php echo e($userDet->name); ?>
                            ...
                            <td>
                                <form action="/admin/userplate/delete" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($row->id); ?>" />
                                    <button type="submit" class="btn btn-danger waves-effect waves-light">حذف</button>
                                </form>
                                <a href="/admin/userplate/single/<?php echo e($row->id); ?>" class="btn btn-secondary waves-effect waves-light">ویرایش</a>
                            </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/userplate/all.blade.php ENDPATH**/ ?>