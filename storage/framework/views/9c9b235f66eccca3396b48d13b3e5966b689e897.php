        ...
        <div class="header-wrapper row m-0">
          ...
          <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-avatar">
              <?php if(Auth::user()->avatar): ?>
              <img src="/uploads/avatars/<?php echo e(auth::user()->avatar); ?>" />
              <?php else: ?>
                  ...
                  <li class="sidebar-main-title">
                    <div>
                      ...
                      <p class="lan-2"><span id="maxDailyCalory">
                        <?php echo e(Auth::user()->calory ? Auth::user()->calory : 'ثبت نشده'); ?>  
                      </span></p>
                    </div>
                  </li>
...
</html><?php /**PATH F:\Projects\atysa-app\resources\views/layouts/user.blade.php ENDPATH**/ ?>