                ...
                <table id="datatable2" class="table table-bordered dt-responsive datatable" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($row->countOfSelection); ?></td>
                            <td><?php echo e(count($row->materialChilds) > 0 ? 'دارد' : 'ندارد'); ?></td>
                            <td>
                                ...
                                <a href="/admin/materials/single/<?php echo e($row->id); ?>" class="btn btn-secondary waves-effect waves-light">ویرایش</a>
                            </td>
                        </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/material/all.blade.php ENDPATH**/ ?>