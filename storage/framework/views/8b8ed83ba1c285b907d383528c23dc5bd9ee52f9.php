...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" action="/admin/companies/create" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <span class="invalid-feedback" role="alert" style="display: block!important">
                                        ...
                                        <div><?php echo e($errors->first('manager')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="plateFee" name="plateFee"/>
                        </div>
                    </div>
                    <div class="form-group row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/admin/company/new.blade.php ENDPATH**/ ?>