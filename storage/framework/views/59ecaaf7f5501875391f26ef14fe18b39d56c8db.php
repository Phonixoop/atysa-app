    ...
    <div class="card w-100">
      ...
      <div class="card-body bg-light">
        ...
        <div class="category-level1-pictures row mt-4" style="text-align: center">
          <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-md-2 col-xs-12">
            <?php echo e($row->name); ?>

            <select multiple name="materials[<?php echo e($key); ?>][]" class="form-control select-<?php echo e($key); ?>" data-maximum-selection-length="<?php echo e($row->countOfSelection); ?>">
              <?php $__currentLoopData = $row->materialChilds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option data-val="<?php echo e($row2['name']); ?>" data-calory="<?php echo e($row2['weight']); ?>" value="<?php echo e($row2['name']); ?>"><?php echo e($row2['name']); ?> - <?php echo e($row2['weight']); ?> کالری</option>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\atysa-app\resources\views/user/createPlate.blade.php ENDPATH**/ ?>